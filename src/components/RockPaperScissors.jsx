...
const RockPaperScissors = ({ stableGesture }) => {
  ...
  return (
    <div className="mt-6 w-full max-w-2xl p-5 rounded-2xl bg-gray-800 text-center">
      ...
      {phase === 'idle' && (
        <>
          ...
          <button
            type="button"
            onClick={play}
            className="mt-4 px-6 py-2 rounded-xl font-bold text-black bg-yellow-400 hover:bg-yellow-300"
          >
            Play
          </button>
        </>
      ...
      {phase === 'capture' && (
        <div className="mt-4 text-3xl font-bold text-yellow-400 animate-pulse">
          Show! ✊🖐️✌️
        </div>
      )}
      ...
      {phase === 'reveal' && (
        <>
          ...
          <button
            type="button"
            onClick={play}
            className="mt-3 px-6 py-2 rounded-xl font-bold text-black bg-yellow-400 hover:bg-yellow-300"
          >
            Play again
          </button>
        </>
